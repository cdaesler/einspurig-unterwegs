...
/*
$Id: wpmp_ads_widget_admin.php 195195 2010-01-19 04:11:37Z BAAP $

$URL: http://plugins.svn.wordpress.org/baap-mobile-version/trunk/plugins/wpmp_ads/wpmp_ads_widget_admin.php $
...
<p>
  <?php printf(__("This widget should only be used on mobile themes. If you are using a theme from, or derived from, the BAAP Mobile Version, you will need to enable this widget <a%s>here</a>.", 'wpmp'), " href='/wp-admin/themes.php?page=wpmp_theme_widget_admin' target='_blank'"); ?>
</p>
<p>
