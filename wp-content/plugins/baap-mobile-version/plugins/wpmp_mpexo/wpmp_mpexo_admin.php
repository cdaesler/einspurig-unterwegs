...
/*
$Id: wpmp_barcode_widget_admin.php 180811 2009-12-08 06:13:51Z BAAP $

$URL: http://plugins.svn.wordpress.org/baap-mobile-version/trunk/plugins/wpmp_barcode/wpmp_barcode_widget_admin.php $
...
<div class="wrap">
  <h2>
    ...
    <p style='font-size:small;font-style:italic;margin:0'>
      <?php _e('Part of the BAAP Mobile Version', 'wpmp'); ?>
    </p>
  </h2>
  <p><?php printf(__("<a%s>mpexo</a> is an online directory of mobile sites built using the BAAP Mobile Version.", 'wpmp'), " target='_blank' href='http://www.mpexo.com'"); ?></p>
  ...
  <p><strong><?php _e("This feature is currently in beta.", 'wpmp'); ?></strong> <?php _e("It is therefore disabled by default, but will be <em>enabled</em> by default in the forthcoming v2.0 of the BAAP Mobile Version. Please provide feedback in the meantime.", 'wpmp'); ?></p>
