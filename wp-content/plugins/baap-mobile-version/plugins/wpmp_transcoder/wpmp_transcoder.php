...
/*
$Id: wpmp_transcoder.php 320618 2010-12-08 19:25:40Z BAAP $

$URL: http://plugins.svn.wordpress.org/baap-mobile-version/trunk/plugins/wpmp_transcoder/wpmp_transcoder.php $
...
function wpmp_transcoder_convert_image($url, $width, $height) {
  ...
  $base = get_option('home') . "/wp-content/plugins/baap-mobile-version/plugins/wpmp_transcoder/";
